  ...
  return (
    <div>
      <div className="grid content-center min-w-full min-h-screen">
        <div className="mx-7 mt-20 sm:mx-24 lg:mx-40 xl:mx-56 ">
          <p className="font-black text-zinc-950 text-center text-4xl sm:text-5xl md:text-6xl ">
            Tire suas dúvidas com a comunidade
          </p>
        </div>
        <div className="mx-7 mt-3 sm:mx-28 sm:mt-6 lg:mx-44 xl:mx-60 ">
          <p className="font-normal text-zinc-900 text-sm text-center sm:text-lg md:text-xl ">
